    ...
    return (
        <>
            <div className="flex bg-banner flex-col lg:flex-row  h-screen bg-gray-50">
                ...
                <div className="flex-1 my-auto z-40 bg-white md:bg-[#ffffff9e] rounded-r-[50px] px-10 py-10 flex flex-col justify-center items-start space-y-5">
                    ...
                    <div className="space-y-3 w-full">
                        <div className="flex items-center bg-white border-l-4 border-[#ffaa3e] p-4 rounded-md shadow-sm">
                            ...
                            <a href="tel:9828988333" className="text-sm text-[#005ca8] hover:underline">
                                +91-9828988333
                            </a>
                        </div>
                        <div className="flex items-center bg-white border-l-4 border-[#ffaa3e] p-4 rounded-md shadow-sm">
                            <Mail size={18} className="text-[#ffaa3e] mr-3" />
                            <a href="mailto:leelproperty21@gmail.com" className="text-sm text-[#005ca8] hover:underline">
                                leelproperty21@gmail.com
                            </a>
                        </div>
                        <div className="flex items-center bg-white border-l-4 border-[#ffaa3e] p-4 rounded-md shadow-sm">
                            <MapPin size={18} className="text-[#ffaa3e] mr-3" />
                            <span className="text-sm text-gray-700">
                                near Vision library, Patrakar colony, Dholai, Jaipur, Mohanpura, Rajasthan 302020
                            </span>
                        </div>
                    </div>
                </div>
