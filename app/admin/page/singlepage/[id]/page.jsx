  ...
  return (
    <>
      ...
      <div className="mt-5 container mx-auto lg:w-[90%] p-6 bg-white rounded-lg ">
        <h1 className="text-2xl font-bold text-zinc-900 mb-2 flex justify-between">{project.propertyname}

        <span className=" text-xl text-2">Upload by = <span className=" text-xl text-2"></span>{adminName ? adminName : "Admin not found"}<span/></span>
        </h1>
